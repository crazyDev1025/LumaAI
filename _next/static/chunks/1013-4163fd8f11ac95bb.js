      ...
      let T = (function (e, ...r) {
        ...
        return {
          ...
          classGroups: {
            ...
            grow: [{ grow: U() }],
            shrink: [{ shrink: U() }],
            order: [{ order: ["first", "last", "none", y, k] }],
            "grid-cols": [{ "grid-cols": [N] }],
            "col-start-end": [{ col: ["auto", { span: ["full", y, k] }, k] }],
            "col-start": [{ "col-start": H() }],
            "col-end": [{ "col-end": H() }],
            "grid-rows": [{ "grid-rows": [N] }],
            "row-start-end": [{ row: ["auto", { span: [y, k] }, k] }],
            ...
            "line-clamp": [{ "line-clamp": ["none", x, w] }],
            leading: [
              {
                leading: [
                  "none",
