(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
  [5156],
  {
        ...
        c = (function () {
          ...
          return (
            ...
            (e.fetch = function (t, e) {
              ...
              return (
                (null == (s = this.options.behavior) ? void 0 : s.onFetch) &&
                  (null == (r = this.options.behavior) || r.onFetch(y)),
                ...
                (this.state.isFetching &&
                  ...
                  this.dispatch({
                    type: "fetch",
                    meta: null == (u = y.fetchOptions) ? void 0 : u.meta,
                  }),
            ...
            (e.reducer = function (t, e) {
              ...
              switch (e.type) {
                ...
                case "error":
                  var u = e.error;
                  if ((0, a.DV)(u) && u.revert && this.revertState)
                    return (0, r.Z)({}, this.revertState);
                  return (0, r.Z)({}, t, {
                    error: u,
        ...
        h = (function (t) {
          ...
          return (
            (n.build = function (t, e, n) {
              var r,
                u = e.queryKey,
                s = null != (r = e.queryHash) ? r : (0, i.Rm)(u, e),
                o = this.get(s);
              return (
                o ||
                  ((o = new c({
        ...
        return (
          ...
          (e.invalidateQueries = function (t, e, n) {
            var u,
              ...
              d = (0, r.Z)({}, h, {
                active:
                  null == (u = null != (o = h.refetchActive) ? o : h.active) ||
                  u,
          ...
          (e.refetchQueries = function (t, e, n) {
            ...
            return (
              (null == c ? void 0 : c.throwOnError) || (l = l.catch(i.ZT)), l
            );
          }),
                    ...
                    if (p.length) {
                      if (d) {
                        ...
                        var F,
                          ...
                          w = E
                            ? f
                            : null == (F = t.options).getPreviousPageParam
                            ? void 0
                            : F.getPreviousPageParam(p[0], p);
                        c = P(p, E, w, !0);
                      } else
                        !(function () {
                          C = [];
                          ...
                          c =
                            !l || !p[0] || l(p[0], 0, p)
                              ? P([], e, m[0])
                              : Promise.resolve(Q([], m[0], p[0]));
                          for (
                            var n = function (n) {
                                c = c.then(function (r) {
                                  if (!l || !p[n] || l(p[n], n, p)) {
                                    var i = e ? m[n] : y(t.options, r);
                                    return P(r, e, i);
                                  }
                                  return Promise.resolve(Q(r, m[n], p[n]));
                                });
                              },
                              r = 1;
                            r < p.length;
    ...
    54642: function (t, e, n) {
      ...
      function f(t, e, n) {
        return O(t) ? [(0, r.Z)({}, e, { queryKey: t }), n] : [t || {}, e];
      }
      function d(t, e) {
        var n = t.active,
          r = t.exact,
      ...
      function v(t, e) {
        ...
        if (O(u)) {
          ...
          } else if (!m(e.options.mutationKey, u)) return !1;
        }
        return (
    ...
    84891: function (t, e, n) {
      ...
      var r,
        i = n(65894),
        u = n(32017).unstable_batchedUpdates;
      i.V.setBatchNotifyFunction(u);
      var s = n(98773),
        o = console;
      (0, s.E)(o);
      var a = n(83112),
      ...
      var f = function () {
          var t = a.useContext(h(a.useContext(l)));
          if (!t)
            throw Error(
        ...
        d = function (t) {
          ...
          return a.createElement(
            l.Provider,
            { value: r },
            a.createElement(u.Provider, { value: e }, i)
          );
        },
        v = n(54080),
        p = n(54642),
      ...
      function O(t, e, n) {
        var r = a.useRef(!1),
          ...
          o = f(),
          c = a.useRef();
        c.current ? c.current.setOptions(s) : (c.current = new g(o, s));
        ...
        if (l.error && C(void 0, c.current.options.useErrorBoundary, [l.error]))
          throw l.error;
        return (0, v.Z)({}, l, { mutate: h, mutateAsync: l.mutate });
      }
      var R = n(92448),
        Q = n(26552),
        P = (function (t) {
          ...
          return (
            ...
            (n.trackResult = function (t, e) {
              ...
              return (
                ...
                (e.useErrorBoundary || e.suspense) && i("error"),
                r
              );
            }),
            ...
            (n.executeFetch = function (t) {
              ...
              return (
                (null == t ? void 0 : t.throwOnError) || (e = e.catch(p.ZT)), e
              );
            }),
            ...
            (n.createResult = function (t, e) {
              ...
              if (
                ...
                (n = f.data), (v = f.dataUpdatedAt), (g = f.status), (C = !0);
                  ...
                  try {
                    (this.selectFn = e.select),
                      ...
                      !1 !== e.structuralSharing &&
                        (n = (0, p.Q$)(null == o ? void 0 : o.data, n)),
                      (this.selectResult = n),
              ...
              if (
                ...
                if (
                  ...
                  try {
                    (r = e.select(r)),
                      !1 !== e.structuralSharing &&
                        (r = (0, p.Q$)(null == o ? void 0 : o.data, r)),
                      (this.selectError = null);
                  } catch (t) {
                    (0, s.j)().error(t), (this.selectError = t);
                  }
                void 0 !== r && ((g = "success"), (n = r), (O = !0));
              }
              return (
                this.selectError &&
                  ((y = this.selectError),
            ...
            (n.shouldNotifyListeners = function (t, e) {
              ...
              if ((!r && !i) || ("tracked" === r && !this.trackedProps.length))
                return !0;
            ...
            (n.onQueryUpdate = function (t) {
              ...
              "success" === t.type
                ? (e.onSuccess = !0)
                : "error" !== t.type || (0, Q.DV)(t.error) || (e.onError = !0),
                this.updateResult(e),
      ...
      function S(t, e) {
        return (
          ...
          (t.state.dataUpdatedAt > 0 && q(t, e, e.refetchOnMount))
        );
      }
      function q(t, e, n) {
        if (!1 !== e.enabled) {
      ...
      function T(t, e, n) {
        return (function (t, e) {
          var n = a.useRef(!1),
            ...
            u = f(),
            s = a.useContext(w),
            o = u.defaultQueryObserverOptions(t);
          (o.optimisticResults = !0),
            o.onError && (o.onError = i.V.batchCalls(o.onError)),
            o.onSuccess && (o.onSuccess = i.V.batchCalls(o.onSuccess)),
            o.onSettled && (o.onSettled = i.V.batchCalls(o.onSettled)),
            o.suspense &&
              ("number" != typeof o.staleTime && (o.staleTime = 1e3),
              0 === o.cacheTime && (o.cacheTime = 1)),
          ...
          if (
            ...
            o.suspense && l.isLoading)
          )
            throw c
              .fetchOptimistic(o)
              .then(function (t) {
                var e = t.data;
                null == o.onSuccess || o.onSuccess(e),
                  null == o.onSettled || o.onSettled(e, null);
              })
              .catch(function (t) {
                s.clearReset(),
                  null == o.onError || o.onError(t),
                  null == o.onSettled || o.onSettled(void 0, t);
              });
          if (
            l.isError &&
            !s.isReset() &&
            !l.isFetching &&
            C(o.suspense, o.useErrorBoundary, [l.error, c.getCurrentQuery()])
          )
            throw l.error;
          return (
            "tracked" === o.notifyOnChangeProps && (l = c.trackResult(l, o)), l
          );
        })((0, p._v)(t, e, n), P);
      }
    },
    54080: function (t, e, n) {
      "use strict";
      function r() {
