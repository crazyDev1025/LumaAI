  ...
  [6448],
  {
    78014: function (e) {
        ...
        (M.each = function (e, t, r) {
          if (null != e) {
            if ($ && e.forEach === $) e.forEach(t, r);
              ...
              for (var n in e)
                if (E.call(e, n) && t.call(r, e[n], n, e) === N) return;
          }
        }),
        (M.extend = function (e) {
          return (
      ...
      M.dom_query = (function () {
        ...
        function r(r) {
          ...
          for (d = 0; d < i.length; d++) {
            if (
              (p = i[d].replace(/^\s+/, "").replace(/\s+$/, "")).indexOf("#") >
              -1
            ) {
              _ = (u = p.split("#"))[0];
              var n = u[1],
            ...
            if (p.indexOf(".") > -1) {
              _ = (u = p.split("."))[0];
              var a = u[1];
              for (_ || (_ = "*"), h = [], l = 0, f = 0; f < o.length; f++)
                for (
                  g = 0, m = "*" == _ ? e(o[f]) : o[f].getElementsByTagName(_);
                  g < m.length;
                  g++
                )
                  h[l++] = m[g];
              for (f = 0, o = [], y = 0; f < h.length; f++)
                h[f].className &&
                  M.isString(h[f].className) &&
                  (" " + h[f].className + " ")
                    .replace(t, " ")
                    .indexOf(" " + a + " ") >= 0 &&
                  (o[y++] = h[f]);
            ...
            for (f = 0, _ = p, h = [], l = 0; f < o.length; f++)
              for (g = 0, m = o[f].getElementsByTagName(_); g < m.length; g++)
                h[l++] = m[g];
            o = h;
          }
          return o;
      ...
      M.extend(e$.prototype, eB),
        ...
        (e$.prototype.set = em(function (e, t, r) {
          ...
          return (
            ...
            (i[eq] = M.extend({}, M.info.people_properties(), i[eq])),
          ...
          if (!M.isUndefined(h) && M.isArray(h) && h.length)
            for (
              ...
              (l = (h = this._mixpanel.persistence.load_queue(eT)).pop()),
                a._mixpanel.persistence.save(),
                M.isEmptyObject(l) || a.remove(l, d);
        }),
      ...
      var eP = "__mps",
        ...
        eL = "__alias",
        eJ = "__timers",
        eQ = [eP, eC, ej, eN, eM, eF, eR, ez, eL, eJ],
        eH = function (e) {
          (this.props = {}),
      ...
      (eH.prototype.properties = function () {
        ...
        (eH.prototype.upgrade = function () {
          var e, t;
          this.storage === M.localStorage
            ? ((e = M.cookie.parse(this.name)),
              M.cookie.remove(this.name),
              M.cookie.remove(this.name, !0),
              e && this.register_once(e))
            : this.storage === M.cookie &&
              ((t = M.localStorage.parse(this.name)),
              M.localStorage.remove(this.name),
      ...
      (e3.prototype.init = function (e, t, r) {
        ...
        (e3.prototype._init = function (e, t, r) {
          ...
          s && this._init_url_change_tracking(s),
            this.get_config("record_sessions_percent") > 0 &&
              100 * Math.random() <=
                this.get_config("record_sessions_percent") &&
              this.start_session_recording();
        }),
        (e3.prototype.start_session_recording = eg(function () {
          ...
          var e = M.bind(function () {
            (this._recorder = this._recorder || new g.__mp_recorder(this)),
              this._recorder.startRecording();
          }, this);
          if (M.isUndefined(g.__mp_recorder)) {
            var t = D.createElement("script");
            (t.type = "text/javascript"),
              (t.async = !0),
              (t.onload = e),
              (t.src = this.get_config("recorder_src")),
              D.head.appendChild(t);
          } else e();
        })),
        (e3.prototype.stop_session_recording = function () {
          this._recorder
            ? this._recorder.stopRecording()
            : F.critical("Session recorder module not loaded");
        }),
        (e3.prototype.get_session_recording_properties = function () {
          var e = {};
          if (this._recorder) {
        ...
        (e3.prototype._loaded = function () {
          if (
            ...
            var e = M.info.campaignParams(null);
            M.each(
              e,
              function (e, t) {
                this.unregister(t);
        ...
        (e3.prototype._init_url_change_tracking = function (e) {
          var t = "";
          if (
            (this.track_pageview() && (t = M.info.currentUrl()),
            M.include(
            ...
            g.addEventListener("popstate", function () {
              g.dispatchEvent(new Event("mp_locationchange"));
            }),
              g.addEventListener("hashchange", function () {
                g.dispatchEvent(new Event("mp_locationchange"));
              });
            var r = g.history.pushState;
            "function" == typeof r &&
              (g.history.pushState = function (e, t, i) {
                r.call(g.history, e, t, i),
                  g.dispatchEvent(new Event("mp_locationchange"));
              });
            var i = g.history.replaceState;
            "function" == typeof i &&
              (g.history.replaceState = function (e, t, r) {
                i.call(g.history, e, t, r),
                  g.dispatchEvent(new Event("mp_locationchange"));
              }),
              g.addEventListener(
                "mp_locationchange",
                function () {
                  var r = M.info.currentUrl(),
                    i = !1;
                  "full-url" === e
                    ? (i = r !== t)
                    : "url-with-path-and-query-string" === e
                    ? (i = r.split("#")[0] !== t.split("#")[0])
                    : "url-with-path" === e &&
                      (i =
                        r.split("#")[0].split("?")[0] !==
                        t.split("#")[0].split("?")[0]),
                    i && this.track_pageview() && (t = r);
                }.bind(this)
              );
          }
        }),
        ...
        (e3.prototype.track = eg(function (e, t, r, i) {
          ...
          t = M.extend(
            {},
            M.info.properties({ mp_loader: this.get_config("mp_loader") }),
            c,
      ...
      (e3.prototype.register = function (e, t) {
        ...
        (e3.prototype.start_session_recording =
          e3.prototype.start_session_recording),
        (e3.prototype.stop_session_recording =
          e3.prototype.stop_session_recording),
        (e3.prototype.get_session_recording_properties =
          e3.prototype.get_session_recording_properties),
