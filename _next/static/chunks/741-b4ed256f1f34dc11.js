    ...
    94678: function (t, e, n) {
      ...
      function O(t, e, n) {
        ...
        let D = t.ownerDocument,
          ...
          { mergeOptions: P, optionsAtMedia: j, optionsMediaQueries: N } = L,
          { on: T, off: z, emit: V } = F,
          H = !1,
          C = P(E, O.globalOptions),
          _ = P(C),
          B = [];
        function R(e, n) {
          !H &&
                ...
                let {
                  ...
                  ts = (
                    ...
                    let p = t.settled(),
                      m = !s.shouldConstrain(),
                      g = f ? p : p && m;
                    g && !c.pointerDown() && (a.stop(), l.emit("settle")),
                      g || l.emit("scroll");
                    let h = n.get() * d + i.get() * (1 - d);
                    r.set(h),
                      f && (o.loop(t.direction()), u.loop()),
                      e.to(r.get());
                  },
                  tf = (function (t, e, n, r) {
                    let i = v(),
                  ...
                  tv = (function (t, e, n, r, i, o, u) {
                    function c(i) {
                      ...
                      o.add(c),
                        ...
                        a && (n.set(e.get()), e.set(i.index), u.emit("select"));
                    }
                    return {
                  ...
                  { slideRegistry: tE } = (function (t, e, n, r, i, o) {
                    let { groupSlides: u } = i,
                      { min: c, max: a } = r;
                    return {
                    ...
                    dragHandler: (function (
                      ...
                      function $(t) {
                        let e = p.byDistance(0, !1).index !== m.get(),
                          n =
                            o.pointerUp(t) * (y ? j : P)[B ? "mouse" : "touch"],
                          r = (function (t, e) {
                            let n = m.add(-1 * d(t)),
                        ...
                        (C = !1),
                          (H = !1),
                          M.clear(),
                          s.useDuration(N - 10 * i).useFriction(0.68 + i / 50),
                          a.distance(r, !y),
                          (B = !1),
                          g.emit("pointerUp");
                      }
                      function q(t) {
                        _ &&
                          (t.stopPropagation(), t.preventDefault(), (_ = !1));
                      }
                      return {
                        init: function (t) {
                          O &&
                            A.add(e, "dragstart", (t) => t.preventDefault(), L)
                              .add(e, "touchmove", () => void 0, L)
            ...
            N([C, ...B.map(({ options: t }) => t)]).forEach((t) =>
              M.add(t, "change", $)
            ),
            _.active &&
        ...
        function $(t, e) {
          let n = J();
          q(), R(P({ startIndex: n }, t), e), F.emit("reInit");
        }
        function q() {
        ...
        let X = {
          ...
          destroy: function () {
            H || ((H = !0), M.clear(), q(), F.emit("destroy"), F.clear());
          },
          off: z,
          on: T,
          emit: V,
